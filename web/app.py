...
async def send_results(
    ...
    messages = {
        'en': {
            ...
            'intro': 'Hello,\n\nYour BILBO (Bilayer Lipid Builder and Organizer) bilayer build has been completed. The output files are attached to this message.',
        ...
        'fr': {
            ...
            'intro': 'Bonjour,\n\nVotre construction de bicouche BILBO (Bilayer Lipid Builder and Organizer) a été finalisée. Les fichiers de sortie sont joints à ce message.',
        ...
        'es': {
            ...
            'intro': 'Hola,\n\nSu construcción de bicapa BILBO (Bilayer Lipid Builder and Organizer) ha sido finalizada. Los archivos de salida se encuentran adjuntos a este mensaje.',
        ...
        'pt': {
            ...
            'intro': 'Olá,\n\nA construção da sua bicamada no BILBO (Bilayer Lipid Builder and Organizer) foi concluída. Os arquivos de saída estão anexados a esta mensagem.',
        ...
        'zh': {
            ...
            'intro': '您好，\n\n您的 BILBO（Bilayer Lipid Builder and Organizer）双层膜构建已完成。输出文件已附在本邮件中。',
            'summary_h': '构建摘要：',
            'date_label': '日期/时间',
            'interp_h': '解释说明：',
            'disclaimer_h': '重要提示：',
    ...
    messages = {
        'en': {
            ...
            'body': (
                ...
                'It places proteins or peptides on or inside the membrane, solvates the '
                'system with explicit TIP3P water and neutralizing ions (Na+/Cl-), and '
                'exports a self-contained GROMACS MD package: CHARMM36 force field bundled, '
                'MDP parameter files included, and a ready-to-run gmx.sh script. '
                'The output goes from sequence to energy-minimized starting structure '
                'with no additional downloads.\n\n'
                '17 curated membrane presets are available directly in the web interface, '
                'covering compositions from pure POPC to complex asymmetric plasma membrane '
                'models. The GROMACS pipeline has been validated end-to-end through a full '
                'energy minimization run.\n\n'
                'Built with Python, FastAPI, NumPy, SQLAlchemy, Docker, and JavaScript. '
                'Runs directly in the browser, with no installation required. The CLI, '
                'web, and pip package deliver identical output.\n\n'
                'Available in three formats:\n'
                f'Web: {site_url}\n'
                'CLI / repo: https://github.com/madsondeluna/bilbo\n'
                'Python package: pip install bilbo-md  (under development)\n\n'
        ...
        'fr': {
            ...
            'body': (
                ...
                'dans la membrane, solubilise le système avec de l\'eau TIP3P explicite '
                'et des ions neutralisants (Na+/Cl-), et exporte un paquet GROMACS '
                'autonome: champ de forces CHARMM36 inclus, fichiers MDP fournis, et '
                'script gmx.sh prêt à l\'exécution. La sortie va de la séquence à une '
                'structure de départ minimisée en énergie sans téléchargement supplémentaire.\n\n'
                '17 préréglages de membrane curatés sont disponibles directement dans '
                'l\'interface web, couvrant des compositions allant du POPC pur à des '
                'modèles complexes de membrane plasmique asymétrique. Le pipeline GROMACS '
                'a été validé de bout en bout par une minimisation d\'énergie complète.\n\n'
                'Construit avec Python, FastAPI, NumPy, SQLAlchemy, Docker et JavaScript. '
                'Fonctionne directement dans le navigateur, sans aucune installation. Les '
                'versions CLI, web et pip produisent des résultats identiques.\n\n'
                'Disponible en trois formats:\n'
                f'Web: {site_url}\n'
                'CLI / dépôt: https://github.com/madsondeluna/bilbo\n'
                'Paquet pip: pip install bilbo-md  (under development)\n\n'
        ...
        'es': {
            ...
            'body': (
                ...
                'de la membrana, solva el sistema con agua TIP3P explícita e iones '
                'neutralizantes (Na+/Cl-), y exporta un paquete GROMACS autónomo: campo '
                'de fuerzas CHARMM36 incluido, archivos MDP provistos, y un script gmx.sh '
                'listo para ejecutar. La salida va de la secuencia a una estructura inicial '
                'minimizada en energía sin descargas adicionales.\n\n'
                '17 preajustes de membrana curados están disponibles directamente en la '
                'interfaz web, cubriendo composiciones desde POPC puro hasta modelos '
                'complejos de membrana plasmática asimétrica. El pipeline GROMACS ha sido '
                'validado de extremo a extremo mediante una minimización de energía completa.\n\n'
                'Construido con Python, FastAPI, NumPy, SQLAlchemy, Docker y JavaScript. '
                'Funciona directamente en el navegador, sin necesidad de instalación. Las '
                'versiones CLI, web y pip producen resultados idénticos.\n\n'
                'Disponible en tres formatos:\n'
                f'Web: {site_url}\n'
                'CLI / repo: https://github.com/madsondeluna/bilbo\n'
                'Paquete pip: pip install bilbo-md  (under development)\n\n'
        ...
        'pt': {
            ...
            'body': (
                ...
                'membrana, solubiliza o sistema com água TIP3P explícita e íons '
                'neutralizantes (Na+/Cl-), e exporta um pacote GROMACS autossuficiente: '
                'campo de força CHARMM36 incluído, arquivos MDP prontos, e script gmx.sh '
                'pronto para execução. A saída vai da sequência a uma estrutura inicial '
                'minimizada em energia sem downloads adicionais.\n\n'
                '17 presets de membrana curados estão disponíveis diretamente na interface '
                'web, cobrindo composições de POPC puro a modelos complexos de membrana '
                'plasmática assimétrica. O pipeline GROMACS foi validado de ponta a ponta '
                'por uma minimização de energia completa.\n\n'
                'Construído com Python, FastAPI, NumPy, SQLAlchemy, Docker e JavaScript. '
                'Roda diretamente no navegador, sem necessidade de instalação. CLI, web e '
                'pacote pip entregam resultados idênticos.\n\n'
                'Disponível em três formatos:\n'
                f'Web: {site_url}\n'
                'CLI / repo: https://github.com/madsondeluna/bilbo\n'
                'Pacote pip: pip install bilbo-md  (under development)\n\n'
        ...
        'zh': {
            ...
            'body': (
                ...
                '使用显式 TIP3P 水和中和离子（Na+/Cl-）对系统进行溶剂化，并导出一个自包含的 '
                'GROMACS MD 包：内置 CHARMM36 力场、提供 MDP 参数文件，以及可直接运行的 '
                'gmx.sh 脚本。输出结果从序列直接到经过能量最小化的起始结构，无需额外下载。\n\n'
                'Web 界面直接提供 17 个经过精心整理的膜预设，涵盖从纯 POPC 到复杂不对称质膜模型的组成。'
                'GROMACS 流程已通过完整能量最小化运行进行端到端验证。\n\n'
                '使用 Python、FastAPI、NumPy、SQLAlchemy、Docker 和 JavaScript 构建。可直接在浏览器中运行，无需安装。'
                'CLI、Web 和 pip 包产生相同的输出结果。\n\n'
                '提供三种格式：\n'
                f'Web: {site_url}\n'
                'CLI / repo: https://github.com/madsondeluna/bilbo\n'
                'Python 包: pip install bilbo-md  (under development)\n\n'
